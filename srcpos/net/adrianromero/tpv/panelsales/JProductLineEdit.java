...
public class JProductLineEdit extends javax.swing.JDialog {
    ...
    private boolean init(UserView user, TicketLineInfo oLine) {
        ...
        m_jName.setEnabled(m_oLine.getProductReference() == null && user.getUser().hasPermission("net.adrianromero.tpv.panelsales.JPanelTicketEdits"));
        m_jPrice.setEnabled(user.getUser().hasPermission("net.adrianromero.tpv.panelsales.JPanelTicketEdits"));
        m_jPriceTax.setEnabled(user.getUser().hasPermission("net.adrianromero.tpv.panelsales.JPanelTicketEdits"));
    ...
    public static boolean showMessage(Component parent, UserView user, TicketLineInfo oLine) {
