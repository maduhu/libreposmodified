...
package net.adrianromero.tpv.panelsales.shared;
...
public class JTicketsBagShared extends JTicketsBag {
    ...
    public JTicketsBagShared(AppView oApp, UserView user, TicketsEditor panelticket) {
    ...
    public void activate() {
        ...
        // Authorization
        m_jDelTicket.setEnabled(m_User.getUser().hasPermission("net.adrianromero.tpv.panelsales.JPanelTicketEdits"));
    ...
    private void saveCurrentTicket() {
        ...
        if (m_sCurrentTicket != null) {
            try {
                m_App.lookupDataLogic(DataLogicReceipts.class).insertSharedTicket(m_sCurrentTicket, m_panelticket.getActiveTicket());
    ...
    private void setActiveTicket(String id) throws BasicException{
        ...
        // BEGIN TRANSACTION
        TicketInfo ticket = m_App.lookupDataLogic(DataLogicReceipts.class).getSharedTicket(id);
        if (ticket == null)  {
            // Does not exists ???
    ...
    private void selectValidTicket() {
        ...
        try {
            List<SharedTicketInfo> l = m_App.lookupDataLogic(DataLogicReceipts.class).getSharedTicketList();
            if (l.size() == 0) {
                newTicket();
            } else {
    ...
    private void newTicket() {      
        ...
        m_sCurrentTicket = m_fmtid.format(ticket.getId());
        m_panelticket.setActiveTicket(ticket, null);      
    }
