...
public abstract class JPanelTicket extends JPanel implements JPanelView, TicketsEditor {
    ...
    public void activate() throws BasicException {
        ...
        m_jDelete.setEnabled(m_User.getUser().hasPermission("net.adrianromero.tpv.panelsales.JPanelTicketEdits"));
        m_jbtnconfig.setPermissions(m_User.getUser());          
    }
    ...
    public void setActiveTicket(TicketInfo oTicket, Object oTicketExt) {
        ...
        if (m_oTicket == null) {        
            ...
            m_oTicket.setUser(m_User.getUser().getUserInfo()); // El usuario que lo cobra
        ...
        if (cTrans == '\n') {
            ...
            if (cTrans == '\u007f') { 
                ...
                if (m_App.getDeviceScale().existsScale()) {
                    try {
                        double dweight = m_App.getDeviceScale().readWeight();
                        if (dweight > 0.002 && m_User.getUser().hasPermission("net.adrianromero.tpv.panelsales.JPanelTicketEdits")) {
                            // correct weight and authorization
            ...
            // Anadimos 1 producto
                    ...
                    && m_iNumberStatusInput == NUMBERVALID && m_iNumberStatusPor == NUMBERZERO
                    && m_User.getUser().hasPermission("net.adrianromero.tpv.panelsales.JPanelTicketEdits")) {
                ...
                if (m_oTicket.getLinesCount() > 0) {
                    ...
                    SwingUtilities.invokeLater(new Runnable() {
                        public void run() {
                            ...
                            String sresourcename = JPaymentSelect.showMessage(JPanelTicket.this, m_App, m_User, m_oTicket);
                            ...
                            if (sresourcename != null) { // Han pulsado aceptar.
                                ...
                                // aquí sería la apertura de la caja si fue 
                                // pago en efectivo
                                //m_App.getDeviceTicket().getDevicePrinter(m_App.getProperty("printer")==null?"1":m_App.getProperty("printer")).openDrawer();
    ...
    private void visorTicketLine(TicketLineInfo oLine){
        if (oLine == null) { 
            ...
            try {
                ...
                m_TTP.printTicket(script.eval(m_App.lookupDataLogic(DataLogicSystem.class).getResourceAsXML("Printer.TicketLine")).toString());
            } catch (ScriptException e) {
...
/** This method is called from within the constructor to
    ...
    private void initComponents() {
        ...
        m_jEditLine.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/color_line.png")));
    ...
    private void m_jEditLineActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jEditLineActionPerformed
        ...
        if (i < 0){
            ...
            TicketLineInfo oLine = m_oTicket.getLine(i);
            if (JProductLineEdit.showMessage(this, m_User, m_oTicket.getLine(i))) {
