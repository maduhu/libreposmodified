...
public class JTicketsBagRestaurantMap extends JTicketsBag {
    ...
    public JTicketsBagRestaurantMap(AppView oApp, UserView user, TicketsEditor panelticket) {
        ...
        super(oApp, user, panelticket);
        
        m_restaurantmap = new JTicketsBagRestaurant(m_User, this);
        m_PlaceCurrent = null;
    ...
    public boolean deactivate() {
        ...
        if (viewTables()) {
            ...
            if (m_PlaceCurrent != null) {
                ...
                try {
                    m_App.lookupDataLogic(DataLogicReceipts.class).updateSharedTicket(m_PlaceCurrent.getId(), m_panelticket.getActiveTicket());
    ...
    public void cancelTicket() {
        ...
        if (m_PlaceCurrent != null) {
            ...
            try {
                m_App.lookupDataLogic(DataLogicReceipts.class).deleteSharedTicket(id);
            } catch (BasicException e) {
                new MessageInf(e).show(this);
            }       
    ...
    public void loadTickets() {
        ...
        try {
            java.util.List<SharedTicketInfo> l = m_App.lookupDataLogic(DataLogicReceipts.class).getSharedTicketList();
    ...
    private TicketInfo getTicketInfo(Place place) {
        ...
        try {
            return m_App.lookupDataLogic(DataLogicReceipts.class).getSharedTicket(place.getId());
        } catch (BasicException e) {
        ...
        public void actionPerformed(ActionEvent evt) {    
            ...
            if (m_PlaceClipboard == null) {  
                ...
                if (ticket == null && !m_place.hasPeople()) {
                    ...
                    try {
                        m_App.lookupDataLogic(DataLogicReceipts.class).insertSharedTicket(m_place.getId(), ticket);
                    } catch (BasicException e) {
                ...
                if (ticketclip == null) {
                    ...
                    if (m_PlaceClipboard == m_place) {
                        ...
                        if (ticket == null) {
                            try {
                                m_App.lookupDataLogic(DataLogicReceipts.class).insertSharedTicket(m_place.getId(), ticketclip);
                                m_place.setPeople(true);
                                m_App.lookupDataLogic(DataLogicReceipts.class).deleteSharedTicket(m_PlaceClipboard.getId());
                                m_PlaceClipboard.setPeople(false);
                            } catch (BasicException e) {
                                new MessageInf(e).show(JTicketsBagRestaurantMap.this); // Glup. But It was empty.
                            }                            
    ...
    private void initComponents() {
        ...
        m_jbtnReservations.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/date.png")));
        ...
        m_jbtnRefresh.setIcon(new javax.swing.ImageIcon(getClass().getResource("/net/adrianromero/images/reload.png")));
