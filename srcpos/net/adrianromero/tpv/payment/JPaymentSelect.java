...
import org.emar.prepaid.tpv.payment.JPaymentPrepaidCard;
...
public class JPaymentSelect extends javax.swing.JDialog 
    ...
    private String init(AppView app, UserView user, TicketInfo ticket) {
        ...
        if (m_dTotal >= 0.0) { 
            // Entrada de dinero
            // marcelo andrade
            // aquí sería aumentar el pago mixto
            addTabPayment(new JPaymentPrepaidCard(this, user), 
                    user.getUser().hasPermission("payment.prepaidcard"),
                    "tab.prepaidcard", 
                    "/net/adrianromero/images/vcard.png");
            addTabPayment(new JPaymentCashPos(this), 
                    user.getUser().hasPermission("payment.cash"),
                    "tab.cash", 
                    "/net/adrianromero/images/cash.png");
            addTabPayment(new JPaymentCheque(this), 
                    user.getUser().hasPermission("payment.cheque"),
                    "tab.cheque", 
                    "/net/adrianromero/images/desktop.png");
            addTabPayment(new JPaymentPaper(this, "paperin"), 
                    user.getUser().hasPermission("payment.paper"),
                    "tab.paper", 
                    "/net/adrianromero/images/knotes.png");            
            addTabPayment(new JPaymentTicket(this), 
                    user.getUser().hasPermission("payment.ticket"),
                    "tab.ticket", 
                    "/net/adrianromero/images/kontact.png");
            addTabPayment(new JPaymentMagcard(app, this), 
                    user.getUser().hasPermission("payment.magcard"),
                    "tab.magcard", 
                    "/net/adrianromero/images/vcard.png");
            addTabPayment(new JPaymentFree(this), 
                    user.getUser().hasPermission("payment.free"),
                    "tab.free", 
                    "/net/adrianromero/images/package_toys.png");
        } else { 
            // devoluciones...
            addTabPayment(new JPaymentRefund(this, "cashrefund"), 
                    user.getUser().hasPermission("refund.cash"),
                    "tab.cashrefund", 
                    "/net/adrianromero/images/cash.png");
            addTabPayment(new JPaymentRefund(this, "chequerefund"), 
                    user.getUser().hasPermission("refund.cheque"),
                    "tab.chequerefund", 
                    "/net/adrianromero/images/desktop.png");
            addTabPayment(new JPaymentRefund(this, "paperout"), 
                    user.getUser().hasPermission("refund.paper"),
                    "tab.paper", 
                    "/net/adrianromero/images/knotes.png");            
            addTabPayment(new JPaymentMagcard(app, this), 
                    user.getUser().hasPermission("refund.magdard"),
                    "tab.magcard", 
                    "/net/adrianromero/images/vcard.png");
    ...
    public static String showMessage(Component parent, AppView app, UserView user, TicketInfo ticket) {
        ...
        return myMsg.init(app, user, ticket);
    }  
