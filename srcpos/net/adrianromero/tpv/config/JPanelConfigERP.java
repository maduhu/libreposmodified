...
public class JPanelConfigERP extends javax.swing.JPanel implements PanelConfig {
    ...
    private void initComponents() {
        ...
        add(jlabelUrl);
        jlabelUrl.setBounds(20, 40, 130, 14);

        jLabelId.setText(AppLocal.getIntString("label.erpid"));
        add(jLabelId);
        jLabelId.setBounds(20, 70, 130, 14);

        jLabelName.setText(AppLocal.getIntString("label.erpuser"));
        add(jLabelName);
        jLabelName.setBounds(20, 160, 130, 14);

        jLabelProperties.setText(AppLocal.getIntString("label.erppassword"));
        add(jLabelProperties);
        jLabelProperties.setBounds(20, 190, 130, 14);

        add(jtxtUrl);
        jtxtUrl.setBounds(150, 40, 380, 20);

        add(jtxtId);
        jtxtId.setBounds(150, 70, 180, 20);

        add(jtxtName);
        jtxtName.setBounds(150, 160, 180, 20);

        jLabelConfiguracion.setFont(new java.awt.Font("Dialog", 1, 12));
        ...
        jLabelConfiguracion.setBounds(20, 10, 660, 17);
        ...
        add(jLabel1);
        jLabel1.setBounds(20, 100, 130, 14);
        ...
        add(jTextField2);
        jTextField2.setBounds(150, 130, 180, 20);
