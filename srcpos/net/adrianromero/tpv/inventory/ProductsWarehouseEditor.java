/*
 * ProductsWarehouseEditor.java
 *
 * Created on 29 de mayo de 2007, 23:15
 */
...
public class ProductsWarehouseEditor extends javax.swing.JPanel implements EditorRecord {
    ...
    public void writeValueEdit(Object value) {
        ...
        m_sProduct = myprod[0];
        m_sName = myprod[1];
        m_sLocation = myprod[2];
        m_jTitle.setText(Formats.STRING.formatValue(myprod[0]) + " - " + Formats.STRING.formatValue(myprod[1]));
        m_jQuantity.setText(Formats.DOUBLE.formatValue(myprod[5]));
        m_jMinimum.setText(Formats.DOUBLE.formatValue(myprod[3]));
        m_jMaximum.setText(Formats.DOUBLE.formatValue(myprod[4]));
        m_jMinimum.setEnabled(true);
        m_jMaximum.setEnabled(true);
     }
    public void writeValueDelete(Object value) {
        ...
        m_sName = myprod[1];
        m_sLocation = myprod[2];
        m_jTitle.setText(Formats.STRING.formatValue(myprod[0]) + " - " + Formats.STRING.formatValue(myprod[1]) + " " + AppLocal.getIntString("label.recorddeleted"));
        m_jQuantity.setText(Formats.DOUBLE.formatValue(myprod[5]));
        m_jMinimum.setText(Formats.DOUBLE.formatValue(myprod[3]));
        m_jMaximum.setText(Formats.DOUBLE.formatValue(myprod[4]));
        m_jMinimum.setEnabled(false);
    ...
    public Object createValue() throws BasicException {
        Object[] productstock = new Object[6];
        productstock[0] = m_sProduct;
        productstock[1] = m_sName;
        productstock[2] = m_sLocation;
        productstock[3] = Formats.DOUBLE.parseValue(m_jMinimum.getText());
        productstock[4] = Formats.DOUBLE.parseValue(m_jMaximum.getText());
        productstock[5] = Formats.DOUBLE.parseValue(m_jQuantity.getText());
        return productstock;
    }
