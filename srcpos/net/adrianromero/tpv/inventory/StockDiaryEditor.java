...
import net.adrianromero.tpv.catalog.CatalogSelector;
import net.adrianromero.tpv.forms.AppLocal;
import net.adrianromero.tpv.forms.AppView;
import net.adrianromero.tpv.forms.SentenceContainer;
import net.adrianromero.tpv.catalog.JCatalog;
...
//    private DirtyManager m_Dirty = new DirtyManager();
    ...
    public StockDiaryEditor(AppView oApp, DirtyManager dirty) {
    ...
    private ProductInfoExt getProductByReference(String sRef)  {
        ...
        try {
            return m_App.lookupDataLogic(SentenceContainer.class).getProductInfo2(sRef);
    ...
    private void assignProductByCode() {
        try {
            ProductInfoExt oProduct = m_App.lookupDataLogic(SentenceContainer.class).getProductInfo(m_jcodebar.getText());
            if (oProduct == null) {       
                assignProduct(null);
    ...
    private void assignProductByReference() {
        try {
            ProductInfoExt oProduct = m_App.lookupDataLogic(SentenceContainer.class).getProductInfo2(m_jreference.getText());
            if (oProduct == null) {       
                assignProduct(null);
                Toolkit.getDefaultToolkit().beep();                   
            } else {
