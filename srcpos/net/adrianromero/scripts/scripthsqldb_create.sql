...
-- Librepos Database initial script for HSQLDB
-- v0.0.24

CREATE TABLE LIBREPOS (
    VERSION VARCHAR NOT NULL,
    PRIMARY KEY (VERSION)
);
INSERT INTO LIBREPOS(VERSION) VALUES('0.0.24');
...
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('0', 'Administrator role', $FILE{/net/adrianromero/templates/Role.Administrator.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('1', 'Manager role', $FILE{/net/adrianromero/templates/Role.Manager.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('2', 'Employee role', $FILE{/net/adrianromero/templates/Role.Employee.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('3', 'Guest role', $FILE{/net/adrianromero/templates/Role.Guest.xml} );
...
INSERT INTO FLOORS(ID, NAME, IMAGE) VALUES ('0', 'Restaurant floor', $FILE{/net/adrianromero/templates/restaurantsample.jpg});
...
CREATE TABLE TARJETA (
  ...
  FECHA_CADUCA DATETIME ,
  SALDO DOUBLE  NOT NULL,
  CLIENTE VARCHAR NOT NULL,
  ESTADO VARCHAR  NOT NULL,
  RECARGABLE VARCHAR NOT NULL,
  PRIMARY KEY(ID)
);
