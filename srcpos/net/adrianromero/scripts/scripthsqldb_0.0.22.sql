...
-- Librepos Database upgrade script for HSQLDB from version 0.0.22 to 0.0.23
-- v0.0.23
...
ALTER TABLE PEOPLE ALTER COLUMN ID VARCHAR NOT NULL;
...
ALTER TABLE RESOURCES ALTER COLUMN ID VARCHAR NOT NULL;
...
ALTER TABLE CATEGORIES ALTER COLUMN ID VARCHAR NOT NULL;

ALTER TABLE TAXES ALTER COLUMN ID VARCHAR NOT NULL;
CREATE UNIQUE INDEX TAXES_NAME_INX ON TAXES(NAME);

ALTER TABLE PRODUCTS ALTER COLUMN CATEGORY VARCHAR NOT NULL;
ALTER TABLE PRODUCTS ALTER COLUMN TAX VARCHAR NOT NULL;

ALTER TABLE LOCATIONS ALTER COLUMN ID VARCHAR NOT NULL;
CREATE UNIQUE INDEX LOCATIONS_NAME_INX ON LOCATIONS(NAME);

ALTER TABLE STOCKDIARY ALTER COLUMN ID VARCHAR NOT NULL;
ALTER TABLE STOCKDIARY ALTER COLUMN LOCATION VARCHAR NOT NULL;
DROP SEQUENCE STOCKDIARYNUM;
ALTER TABLE STOCKCURRENT ALTER COLUMN LOCATION VARCHAR NOT NULL;

ALTER TABLE CLOSEDCASH ALTER COLUMN MONEY VARCHAR NOT NULL;
DROP SEQUENCE CLOSEDCASHNUM;

ALTER TABLE TICKETS ALTER COLUMN MONEY VARCHAR NOT NULL;

ALTER TABLE PRODUCTSOUT ALTER COLUMN TAXID VARCHAR;

ALTER TABLE PAYMENTS ALTER COLUMN ID VARCHAR NOT NULL;
DROP SEQUENCE PAYMENTSNUM;

ALTER TABLE FLOORS ALTER COLUMN ID VARCHAR NOT NULL;
CREATE UNIQUE INDEX FLOORS_NAME_INX ON FLOORS(NAME);

ALTER TABLE PLACES ALTER COLUMN FLOOR VARCHAR NOT NULL;
ALTER TABLE PLACES ADD COLUMN ID VARCHAR;
UPDATE PLACES SET ID = NAME;
ALTER TABLE PLACES ALTER COLUMN ID VARCHAR NOT NULL;
...
ALTER TABLE RESERVATIONS ALTER COLUMN ID VARCHAR NOT NULL;
