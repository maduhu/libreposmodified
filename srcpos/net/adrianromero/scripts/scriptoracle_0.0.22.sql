...
-- Librepos Database upgrade script for Oracle from version 0.0.22 to 0.0.23
-- v0.0.23
...
ALTER TABLE ROLES ADD COLUMN ID VARCHAR2(255);
...
ALTER TABLE PEOPLE ADD COLUMN ID VARCHAR2(255);
...
ALTER TABLE RESOURCES ADD COLUMN ID VARCHAR2(255);
...
ALTER TABLE CATEGORIES ALTER COLUMN ID TYPE VARCHAR2(255);

ALTER TABLE TAXES ALTER COLUMN ID TYPE VARCHAR2(255);
CREATE UNIQUE INDEX TAXES_NAME_INX ON TAXES(NAME);

ALTER TABLE PRODUCTS ALTER COLUMN CATEGORY TYPE VARCHAR2(255);
ALTER TABLE PRODUCTS ALTER COLUMN TAX TYPE VARCHAR2(255);

ALTER TABLE LOCATIONS ALTER COLUMN ID TYPE VARCHAR2(255);
CREATE UNIQUE INDEX LOCATIONS_NAME_INX ON LOCATIONS(NAME);

ALTER TABLE STOCKDIARY ALTER COLUMN ID TYPE VARCHAR2(255);
ALTER TABLE STOCKDIARY ALTER COLUMN LOCATION TYPE VARCHAR2(255);
DROP SEQUENCE STOCKDIARYNUM;
ALTER TABLE STOCKCURRENT ALTER COLUMN LOCATION TYPE VARCHAR2(255);

ALTER TABLE CLOSEDCASH ALTER COLUMN MONEY TYPE VARCHAR2(255);
DROP SEQUENCE CLOSEDCASHNUM;

ALTER TABLE TICKETS ALTER COLUMN MONEY TYPE VARCHAR2(255);

ALTER TABLE PRODUCTSOUT ALTER COLUMN TAXID TYPE VARCHAR2(255);

ALTER TABLE PAYMENTS ALTER COLUMN ID TYPE VARCHAR2(255);
DROP SEQUENCE PAYMENTSNUM;

ALTER TABLE FLOORS ALTER COLUMN ID TYPE VARCHAR2(255);
CREATE UNIQUE INDEX FLOORS_NAME_INX ON FLOORS(NAME);

ALTER TABLE PLACES ALTER COLUMN FLOOR TYPE VARCHAR2(255);
ALTER TABLE PLACES ADD COLUMN ID VARCHAR2(255);
...
ALTER TABLE RESERVATIONS ALTER COLUMN ID TYPE VARCHAR2(255);
