...
import net.adrianromero.tpv.util.Base64Encoder;
...
public class ExternalSalesHelper {
    ...
    public ExternalSalesHelper(AppView app) throws BasicException, ServiceException, MalformedURLException {
        
        
        Properties prop = app.lookupDataLogic(DataLogicSystem.class).getResourceAsProperties("openbravo.properties");
        if (prop == null) {
            ...
            if (url == null || url.equals("")) {
                ...
                if (m_sERPUser != null && m_sERPPassword != null && m_sERPPassword.startsWith("crypt:")) {
                    ...
                    AltEncrypter cypher = new AltEncrypter("librepos" + m_sERPUser);
